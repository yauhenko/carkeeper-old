  ...
  render() {
    ...
    return (
      <React.Fragment>
        ...
        <Button vertical style={active === "Journal" ? styles.footerButtonActive : styles.footerButton} onPress={()=>this.props.navigation.navigate("Journal", {id: this.id})} active={active === "Journal"}>
